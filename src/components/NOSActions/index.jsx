...
class NOSActions extends React.Component {
  ...
  render() {
    ...
    const asset = neo;
    const amount = '11';
    const receiver = 'AaKsUkJejNpYEw4PNzWCPzk2xVFAUeqPbW';
      ...
      <React.Fragment>
        ...
        <form className="container" onSubmit={this.handleFormSubmit}>
          <div class="form-group">
            <label for="address-to">Neo address </label>
            <input type="text" className="form-control" name="address-to" placeholder="Neo address"></input>
          </div>
          <div class="form-group">
            <label for="address-to">Amount </label>
            <input type="text" className="form-control" name="amount" placeholder="amount"></input>
          </div>
